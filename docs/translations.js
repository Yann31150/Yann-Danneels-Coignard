...
const translations = {
    fr: {
        ...
        timeline: {
            ...
            step7Desc: "Recherche active d'une opportunité en tant que Data Analyst (CDD/CDI), ou alternance en tant que Data Analyst, Data Scientist ou Data Engineer pour continuer à apprendre tout en apportant ma valeur ajoutée. Projets freelance en cours dans le cadre de Databridge.ia. Disponible dès septembre 2026, région toulousaine ou télétravail. Prêt à transformer vos données en insights stratégiques.",
