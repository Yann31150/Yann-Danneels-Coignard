...
const translations = {
    fr: {
        ...
        timeline: {
            ...
            step2Desc: "Développement d'une expertise approfondie en analyse financière, gestion des risques et financements complexes. Gestion de portefeuilles importants (jusqu'à 1200 comptes), analyse juridique de dossiers de successions, validation AMF.",
            ...
            step3Desc: "Réalisation que l'analyse de données et la data science représentent l'avenir. Intérêt croissant pour transformer l'information brute en insights actionnables. Début de l'apprentissage autodidacte en Python, SQL et visualisation de données.",
            step3Skill1: "Python",
            step3Skill2: "SQL",
            ...
            step6Desc: "Développement de projets concrets : tableau de bord Power BI pour une entreprise de maquettes, système de recommandation de vins avec machine learning, projet Ludrun (recommandation de jeux vidéo avec IA). Application pratique des compétences acquises.",
            step6Skill1: "Dashboards Power BI",
            step6Skill2: "Machine Learning",
            step6Skill3: "Recommandation IA",
            step6Skill4: "Projets réels",
            year7: "2026",
            step7Title: "Aujourd'hui : Recherche d'Alternance, CDD ou CDI",
            step7Subtitle: "Disponible pour Alternance, CDD ou CDI",
            step7Desc: "Recherche active d'une alternance, CDD ou CDI dans le domaine de la data pour continuer à apprendre tout en apportant ma valeur ajoutée. Disponible dès septembre 2026, région toulousaine ou télétravail. Prêt à mettre mes compétences au service des entreprises.",
    ...
    en: {
        ...
        timeline: {
            ...
            step2Desc: "Development of in-depth expertise in financial analysis, risk management and complex financing. Management of large portfolios (up to 1200 accounts), legal analysis of inheritance files, AMF validation.",
            ...
            step3Desc: "Realization that data analysis and data science represent the future. Growing interest in transforming raw information into actionable insights. Beginning of self-taught learning in Python, SQL and data visualization.",
            step3Skill1: "Python",
            step3Skill2: "SQL",
            ...
            step6Desc: "Development of concrete projects: Power BI dashboard for a model company, wine recommendation system with machine learning, Ludrun project (video game recommendation with AI). Practical application of acquired skills.",
            step6Skill1: "Power BI Dashboards",
            step6Skill2: "Machine Learning",
            step6Skill3: "AI Recommendation",
            step6Skill4: "Real projects",
            year7: "2026",
            step7Title: "Today: Apprenticeship, Fixed-term or Permanent Contract Search",
            step7Subtitle: "Available for Apprenticeship, Fixed-term or Permanent Contract",
            step7Desc: "Active search for an apprenticeship, fixed-term or permanent contract in the data field to continue learning while bringing my added value. Available from September 2026, Toulouse region or remote work. Ready to put my skills at the service of companies.",
