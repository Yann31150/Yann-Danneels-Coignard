...
const translations = {
    fr: {
        ...
        home: {
            ...
            aboutText1: "Après plus de 20 ans d'expérience dans le secteur bancaire, j'ai décidé de me réinventer professionnellement en me tournant vers un domaine qui me passionne : la data et la tech.",
            aboutText2: "Titulaire d'une certification Data Analyst de la Wild Code School de Toulouse, je maîtrise les outils modernes d'analyse de données pour transformer l'information brute en leviers de décision pertinents.",
            aboutText3: "Passionné par les technologies, l'analyse de données et leur impact stratégique, je suis à la recherche d'un CDD, CDI ou poste de Data Analyst dans le domaine de la data.",
            aboutText4: "Mon objectif : mettre mes compétences au service des entreprises pour comprendre les tendances, révéler des insights et améliorer la prise de décision.",
            actualitesDesc: "Découvrez les dernières actualités sur la tech, l'IA, la data et l'innovation, sélectionnées et analysées par intelligence artificielle.",
            actualitesItem1: "Articles quotidiens sélectionnés par IA",
            actualitesItem2: "Vidéos YouTube en français",
            actualitesItem3: "Analyses et tendances",
            actualitesButton: "Voir les actualités",
            cyberDesc: "10 conseils essentiels pour protéger vos données et votre entreprise en 2026. Guide pratique et téléchargeable.",
            cyberItem1: "10 conseils pratiques",
            cyberItem2: "Outils recommandés",
            cyberItem3: "Guide PDF gratuit",
            cyberButton: "Découvrir le guide",
            resourcesTitle: "Ressources gratuites",
            resourcesDesc: "Guides téléchargeables, templates Excel/Power BI et articles de blog pour vous aider dans vos projets data.",
            resourcesGuides: "Guides PDF",
            resourcesTemplates: "Templates",
            resourcesArticles: "Articles",
            resourcesItem1: "Guides pratiques téléchargeables",
            resourcesItem2: "Templates Excel & Power BI",
            resourcesItem3: "Articles de blog data",
            resourcesButton: "Voir les ressources",
            resourcesSectionTitle: "Ressources gratuites",
            resourcesSectionDesc: "Téléchargez gratuitement mes guides, templates et découvrez mes articles pour améliorer vos compétences en data.",
            downloadGuide: "Lire le guide",
            downloadTemplate: "Télécharger",
            readArticle: "Lire l'article",
            guide1Title: "10 KPIs essentiels pour votre entreprise",
            guide1Desc: "Guide complet pour identifier et suivre les KPIs les plus importants.",
            guide2Title: "Débuter avec Power BI",
            guide2Desc: "Guide pratique pour créer vos premiers tableaux de bord.",
            guide3Title: "SQL pour débutants",
            guide3Desc: "Apprenez les bases du SQL avec des exemples pratiques.",
            template1Title: "Dashboard Ventes (Power BI)",
            template1Desc: "Template prêt à l'emploi pour analyser vos ventes.",
            template2Title: "Analyse Financière (Excel)",
            template2Desc: "Template Excel pour suivre vos finances.",
            template3Title: "Suivi RH/KPI (Excel)",
            template3Desc: "Template pour suivre les indicateurs RH.",
            article1Title: "Comment choisir les bons KPIs",
            article1Desc: "Guide pratique pour identifier les KPIs pertinents.",
        ...
        about: {
            ...
            text2: "Titulaire d'une certification Data Analyst de la Wild Code School de Toulouse, je maîtrise les outils modernes d'analyse de données pour transformer l'information brute en leviers de décision pertinents.",
        ...
        timeline: {
            ...
            step1Desc: "Premiers pas dans le secteur bancaire avec une approche orientée client et analyse financière.<br><br>Acquisition des fondamentaux : gestion de portefeuille, analyse de risques, montage de financements.<br><br>Gestion de portefeuilles importants (jusqu'à 1200 comptes).",
            ...
            step3Desc: "Pendant cette période, réalisation que l'analyse de données et la data science représentent l'avenir.<br><br>Intérêt croissant pour transformer l'information brute en insights actionnables.<br><br>Début de l'apprentissage autodidacte en Python, SQL et visualisation de données, tout en continuant l'analyse juridique de successions jusqu'en 2024.",
            step3Skill1: "Python",
            step3Skill2: "SQL",
            ...
            step4Desc: "Après plus de 20 ans dans le secteur bancaire, décision de se réinventer professionnellement.<br><br>Choix de se tourner vers un domaine en pleine expansion qui combine analyse, technologie et impact stratégique : la data analyse.",
            ...
            step6Desc: "Développement de projets concrets : tableau de bord Power BI pour une entreprise de maquettes, système de recommandation de vins avec machine learning, projet Ludrun (recommandation de jeux vidéo avec IA).<br><br>Application pratique des compétences acquises.<br><br><strong>À partir de fin 2025, début de projets freelance dans le cadre de Databridge.ia</strong>.",
            ...
            step7Desc: "Recherche active d'une opportunité en tant que Data Analyst (CDD/CDI), ou alternance en tant que Data Analyst, Data Scientist ou Data Engineer pour continuer à apprendre tout en apportant ma valeur ajoutée.<br><br><strong>Projets freelance en cours dans le cadre de Databridge.ia</strong>.<br><br>Disponible dès maintenant, région toulousaine ou télétravail.<br><br>Prêt à transformer vos données en insights stratégiques.",
    ...
    en: {
        ...
        home: {
            ...
            aboutTitle: "About me",
            aboutText1: "After more than 20 years of experience in the banking sector, I decided to professionally reinvent myself by turning to a field that I am passionate about: data and tech.",
            aboutText2: "Holder of a Data Analyst certification from Wild Code School in Toulouse, I master modern data analysis tools to transform raw information into relevant decision-making levers.",
            aboutText3: "Passionate about technologies, data analysis and their strategic impact, I am looking for a fixed-term contract, permanent contract or Data Analyst position in the data field.",
            aboutText4: "My goal: put my skills at the service of companies to understand trends, reveal insights and improve decision-making.",
            actualitesDesc: "Discover the latest news on tech, AI, data and innovation, selected and analyzed by artificial intelligence.",
            actualitesItem1: "Daily articles selected by AI",
            actualitesItem2: "French YouTube videos",
            actualitesItem3: "Analysis and trends",
            actualitesButton: "View news",
            cyberDesc: "10 essential tips to protect your data and your business in 2026. Practical and downloadable guide.",
            cyberItem1: "10 practical tips",
            cyberItem2: "Recommended tools",
            cyberItem3: "Free PDF guide",
            cyberButton: "Discover the guide",
            resourcesTitle: "Free Resources",
            resourcesDesc: "Downloadable guides, Excel/Power BI templates and blog articles to help you with your data projects.",
            resourcesGuides: "PDF Guides",
            resourcesTemplates: "Templates",
            resourcesArticles: "Articles",
            resourcesItem1: "Downloadable practical guides",
            resourcesItem2: "Excel & Power BI templates",
            resourcesItem3: "Data blog articles",
            resourcesButton: "View resources",
            resourcesSectionTitle: "Free Resources",
            resourcesSectionDesc: "Download my guides, templates and discover my articles for free to improve your data skills.",
            downloadGuide: "Read guide",
            downloadTemplate: "Download",
            readArticle: "Read article",
            guide1Title: "10 Essential KPIs for Your Business",
            guide1Desc: "Complete guide to identify and track the most important KPIs.",
            guide2Title: "Getting Started with Power BI",
            guide2Desc: "Practical guide to create your first dashboards.",
            guide3Title: "SQL for Beginners",
            guide3Desc: "Learn SQL basics with practical examples.",
            template1Title: "Sales Dashboard (Power BI)",
            template1Desc: "Ready-to-use template to analyze your sales.",
            template2Title: "Financial Analysis (Excel)",
            template2Desc: "Excel template to track your finances.",
            template3Title: "HR/KPI Tracking (Excel)",
            template3Desc: "Template to track HR indicators.",
            article1Title: "How to Choose the Right KPIs",
            article1Desc: "Practical guide to identify relevant KPIs.",
        ...
        about: {
            ...
            text2: "Holder of a Data Analyst certification from Wild Code School in Toulouse, I master modern data analysis tools to transform raw information into relevant decision-making levers.",
            text3: "Passionate about technologies, data analysis and their strategic impact, I am looking for a fixed-term contract, permanent contract or Data Analyst position in the data field.",
        ...
        timeline: {
            ...
            step1Desc: "First steps in the banking sector with a client-oriented approach and financial analysis.<br><br>Acquisition of fundamentals: portfolio management, risk analysis, financing structuring.<br><br>Management of large portfolios (up to 1200 accounts).",
            ...
            step2Desc: "Development of in-depth expertise in financial analysis, risk management and complex financing.<br><br>Legal analysis of inheritance files until 2020, AMF validation.",
            ...
            step4Desc: "After more than 20 years in the banking sector, decision to professionally reinvent oneself.<br><br>Choice to turn to a growing field that combines analysis, technology and strategic impact: data analysis.",
            ...
            step5Subtitle: "Wild Code School Toulouse",
            step5Desc: "Integration of Wild Code School Toulouse for intensive Data Analyst training.<br><br>Learning modern tools: advanced SQL, Power BI, Python (Pandas, NumPy, Matplotlib), statistics, machine learning, data storytelling.",
            step5Skill1: "Power BI",
            step5Skill2: "Python",
            step5Skill3: "SQL",
            step5Skill4: "Machine Learning",
            ...
            step6Desc: "Development of concrete projects: Power BI dashboard for a model company, wine recommendation system with machine learning, Ludrun project (video game recommendation with AI).<br><br>Practical application of acquired skills.<br><br><strong>From late 2025, start of freelance projects within Databridge.ia</strong>.",
            ...
            step7Desc: "Active search for an opportunity as a Data Analyst (fixed-term or permanent contract), or apprenticeship as a Data Analyst, Data Scientist or Data Engineer to continue learning while bringing my added value.<br><br><strong>Ongoing freelance projects within Databridge.ia</strong>.<br><br>Available now, Toulouse region or remote work.<br><br>Ready to transform your data into strategic insights.",
            step7Skill1: "Data Analyst",
            step7Skill2: "Data Scientist",
            step7Skill3: "Data Engineer",
