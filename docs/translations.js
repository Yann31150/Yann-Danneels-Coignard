...
const translations = {
    fr: {
        ...
        timeline: {
            ...
            year7: "2026",
            step7Title: "Aujourd'hui : Recherche d'Alternance",
            step7Subtitle: "Disponible pour Alternance, CDD ou CDI",
            step7Desc: "Recherche active d'une alternance dans le domaine de la data pour continuer à apprendre tout en apportant ma valeur ajoutée. Disponible dès septembre 2026, région toulousaine ou télétravail. Prêt à mettre mes compétences au service des entreprises.",
    ...
    en: {
        ...
        timeline: {
            ...
            year7: "2026",
            step7Title: "Today: Apprenticeship Search",
            step7Subtitle: "Available for Apprenticeship, Fixed-term or Permanent Contract",
            step7Desc: "Active search for an apprenticeship in the data field to continue learning while bringing my added value. Available from September 2026, Toulouse region or remote work. Ready to put my skills at the service of companies.",
