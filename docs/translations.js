...
const translations = {
    fr: {
        ...
        timeline: {
            ...
            step6Desc: "Développement de projets concrets : tableau de bord Power BI pour une entreprise de maquettes, système de recommandation de vins avec machine learning, projet Ludrun (recommandation de jeux vidéo avec IA).<br><br>Application pratique des compétences acquises.<br><br>À partir de fin 2025, début de projets freelance dans le cadre de Databridge.ia.",
    ...
    en: {
        ...
        timeline: {
            ...
            step6Desc: "Development of concrete projects: Power BI dashboard for a model company, wine recommendation system with machine learning, Ludrun project (video game recommendation with AI).<br><br>Practical application of acquired skills.<br><br>From late 2025, start of freelance projects within Databridge.ia.",
